...
+ (UIColor *) tealColor {
    static UIColor *teal = nil;
    static dispatch_once_t tealToken;
    
    dispatch_once(&tealToken, ^{
        teal = [UIColor colorFromHexCode:@"03A6A6"];
    });
...
+ (UIColor *) grayDetailColor {
    static UIColor *grayDetail = nil;
    static dispatch_once_t grayDetailToken;
    
    dispatch_once(&grayDetailToken, ^{
        grayDetail = [UIColor colorFromHexCode:@"1B1F1F"];
    });
